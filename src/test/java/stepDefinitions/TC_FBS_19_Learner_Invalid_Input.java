...
public class TC_FBS_19_Learner_Invalid_Input {
    ...
    @Then("The respective {string} error message of No of Learners should be displayed")
    public void the_respective_error_message_of_no_of_learners_should_be_displayed(String row) {
    	try {
	    	int index=Integer.parseInt(row)-1;
			String errMsg = ExcelReadWrite.getCellData(filepath,"sheet1",index,7);
			System.out.println(errMsg);
			boolean exp=CFC.getEMlearn(errMsg);
